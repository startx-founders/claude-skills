...
3. If this is your first contribution, you should be adding a new
   ...
   .github/CODEOWNERS routing that dir to your handle.
-->
...
- [ ] New skill (first-time contributor onboarding)
- [ ] Update to an existing skill in my own /skills/<handle>/ dir
- [ ] Catalog update (only curators should select this)
- [ ] Documentation / CI / other repo-level change

## Skill details (if adding or updating a skill)

- **Skill name:** <!-- kebab-case, e.g. claude-design-for-ads -->
- **Your handle:** <!-- @your-github -->
- **Source:**
  - [ ] Vendored into this repo at `/skills/<handle>/<skill>/`
  - [ ] External — points at my own GitHub repo (specify ref/tag below)
- **External repo + pinned ref (if external):** <!-- e.g. ivy-invest/claude-design-for-ads @ v1.0.0 -->
...
<!-- Curator: confirm StartX membership, sanity-check the skill's README,
     verify the CODEOWNERS line matches the PR author's handle. -->
